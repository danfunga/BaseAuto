...
Class AutoGameMode{
    ...
    checkAndStopStartLimitCount(){
        ...
        this.player.setCurrentModeResult("실대", this.startingLoopLimit)         
    ...
    restartAppPlayer() {
        ...
        if (InStr(targetClassName, "LDPlayer")) {
            this.logger.log("LD Player를 강제 종료 해봅시다")
        ...
        if (this.gameController.searchAndClickFolder("1.공통\버튼_앱강제종료", 0, 0, true, true)) {
            ...
            if (this.gameController.searchImageFolder("1.공통\버튼_앱강제종료\화면_재시작확인")) {
                ...
                if (this.gameController.searchAndClickFolder("1.공통\버튼_앱강제종료\화면_재시작확인\버튼_재시작",0,0,true,true)) {
        ...
        if (this.gameController.searchAndClickFolder("1.공통\버튼_앱강제종료\버튼_LD매니저_종료")) {
            ...
            this.gameController.setActiveId(managerPopupTitle)
            if (this.gameController.searchImageFolder("1.공통\버튼_앱강제종료\버튼_LD매니저_종료\화면_알림확인")) {
                this.logger.log("종료를 확인합니다.")
                if (this.gameController.searchAndClickFolder("1.공통\버튼_앱강제종료\버튼_LD매니저_종료\화면_알림확인\버튼_확인")) {
                    ; this.logger.log("앱이 종료 되길 화면 딜레이 만큼 기다립니다.")
                    ; this.gameController.waitDelayForChangeWindow()
